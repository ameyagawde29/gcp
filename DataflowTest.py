...
class DataflowOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls,parser):
        parser.add_argument('--input_path', type=str, default='gs://new-bucket-1508/input.json') #change bucket name here in the 'gs://...' format
        parser.add_argument('--output_bucket', type=str, default='new-bucket-1508') #change bucket name here in similar format to <--
